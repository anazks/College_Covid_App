...
function ContactForm() {
    ...
    return (
        <div className='contact-form'>
            <Typography fontWeight={700} fontSize={'36px'}>Message to Admin </Typography>
            ...
            <div className="footer">
                <Typography fontWeight={700} fontSize={'32px'}>Create Meeting</Typography>
                <div className="para-container" style={{ display: "flex", justifyContent: "space-around" }}>
                    ...
                    <Button disabled={loading} variant="contained" style={{ width: "200px" }}>Host Meeting</Button>
                </div>
            </div>
